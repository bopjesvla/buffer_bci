...
%  w    -- [d x 1] the linear decision function weights
%  b    -- [1 x 1] the decision function bias term
   ...
   for p=1:nplot;
      ...
      if ( size(w,2)==1 )
         ...
         for i=1:size(w,2);
            ...
            drawLine(w(dims,i),b(i)+rest,minX(dims),maxX(dims),cols(mod(i,numel(cols))+1),'LineWidth',2);
         end
      end
   end
