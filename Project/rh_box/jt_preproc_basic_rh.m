function [X,ret] = jt_preproc_basic_rh(X,cfg)
...
%       .chnthres  = [bool] threshold for channel outlier removal (false)
%       .trlthres  = [bool] threshold for trial outlier removal (false)
...
chnthres    = jt_parse_cfg(cfg,'chnthres',false);
trlthres    = jt_parse_cfg(cfg,'trlthres',false);
