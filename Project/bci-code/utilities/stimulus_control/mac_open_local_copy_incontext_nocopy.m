function mess = mac_open_local_copy_incontext_nocopy(sourcen, targetn, machine, user, password, detach)
quote = char(39);
...
if detach 
    ...
    command = ['!osascript -e ' quote command2 quote ' -e ' quote command1 quote ' -e ' quote command5 quote ' -e ' quote command6 quote ' -e ' quote command4  quote command7]
