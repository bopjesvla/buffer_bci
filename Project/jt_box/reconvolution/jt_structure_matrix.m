...
%
% INPUT
%   V    = [m n]    n sequences of m samples
...
%       .modelonset = [bool] whether or not to model the onset as separate event, if so, it is added as last event with length L(end) (false)
%       .wraparound = [bool] whether or not to wrap M around (false)
%       .symmetric  = [bool] whether or not to make M symmetric (false)
%
% OUTPUT
