...
cfg = struct(...
    ...
    'cca','cov','L',[L L],'event','duration','modelonset',false,'component',1,'lx',.9,'ly','tukey',...
    'lcs','no','lcl','no','covfilter', inf,'marginmethod', 'betadist2',...
    'model','normal','segmentlength',4.2,'maxsegments', 1, 'alpha',.1,'accuracy',0.95,'forcestop',true);
