...
ntrl    = 36; 
cfg = struct(...
    'verbosity',2,'nclasses',36,'fs',fs,'method','bwd','synchronous',true,...
    'cca','cov','L',[.2 .2],'delay',0,'event','duration','modelonset',false,'component',1,'lx',.9,'ly','tukey',...
...
prpcfg = struct('verb',0,'fs',fs,'reref','car','bands',{{[2 48]}},...
    'fronttime',2,'chnthres',false,'trlthres',false);
